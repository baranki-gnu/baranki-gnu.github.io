...
/* harmony import */ var _utils_form_data_storage__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./utils/form-data-storage */ "./js/utils/form-data-storage.js");
/* harmony import */ var _utils_form_validate__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./utils/form-validate */ "./js/utils/form-validate.js");
/* harmony import */ var _utils_navigation_scroll__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./utils/navigation-scroll */ "./js/utils/navigation-scroll.js");
/* harmony import */ var _utils_activate_menu_overlay__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./utils/activate-menu-overlay */ "./js/utils/activate-menu-overlay.js");
/* harmony import */ var _modules_init_map_js__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./modules/init-map.js */ "./js/modules/init-map.js");
/* harmony import */ var _modules_init_map_js__WEBPACK_IMPORTED_MODULE_6___default = /*#__PURE__*/__webpack_require__.n(_modules_init_map_js__WEBPACK_IMPORTED_MODULE_6__);
...
window.addEventListener('DOMContentLoaded', function () {
  ...
  Object(_utils_activate_menu_overlay__WEBPACK_IMPORTED_MODULE_5__["callMenuFunctions"])();
  Object(_utils_navigation_scroll__WEBPACK_IMPORTED_MODULE_4__["turnNavScrollOn"])();
  ...
  window.addEventListener('load', function () {
    ...
    Object(_utils_form_data_storage__WEBPACK_IMPORTED_MODULE_2__["startStoringData"])();
    Object(_utils_form_validate__WEBPACK_IMPORTED_MODULE_3__["turnFormValidationOn"])();
  });
});
...
if (document.querySelector('#YMapsID')) {
  window.ymaps.ready(function () {
    var myMap = new window.ymaps.Map('YMapsID', {
    ...
    var myPlacemark = new window.ymaps.Placemark(myMap.getCenter(), {
...
/***/ "./js/utils/activate-menu-overlay.js":
/*!*******************************************!*\
  !*** ./js/utils/activate-menu-overlay.js ***!
  \*******************************************/
/*! exports provided: callMenuFunctions */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "callMenuFunctions", function() { return callMenuFunctions; });
/* harmony import */ var _trap_menu_focus__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./trap-menu-focus */ "./js/utils/trap-menu-focus.js");

var bodyBlock = document.querySelector('[data-page] body');
var headerBlock = document.querySelector('[data-header]');
var logoLink = headerBlock.querySelector('[data-logo-link]');
var toggleWrap = headerBlock.querySelector('[data-toggle-wrap]');
var toggleButton = headerBlock.querySelector('[data-menu-toggle]');
var menuOverlay = document.querySelector('[data-page-overlay]');
var navigationLinks = document.querySelectorAll('[data-navigation] a');
function lockScroll() {
...
function scrollToBlockMobile(link) {
  if (link.dataset.linkTo) {
    var targetName = link.dataset.linkTo;
    var targetNameData = '[data-' + targetName + ']';
    var targetBlock = document.querySelector(targetNameData);
...
function openMenu() {
  if (headerBlock) {
    ...
    lockScroll();
    Object(_trap_menu_focus__WEBPACK_IMPORTED_MODULE_0__["trapMenuFocus"])(headerBlock);
...
function closeMenu() {
  if (headerBlock) {
    ...
    unlockScroll();
    Object(_trap_menu_focus__WEBPACK_IMPORTED_MODULE_0__["trapMenuFocus"])(headerBlock).onClose();
    document.removeEventListener('keydown', onMenuEscKeydown);
    toggleButton.addEventListener('click', openMenu);
    toggleButton.removeEventListener('click', closeMenu);
    navigationLinks.forEach(function (link) {
      return link.removeEventListener('click', function () {
        closeMenu();
        scrollToBlockMobile(link);
      });
    });
...
/***/ "./js/utils/form-data-storage.js":
/*!***************************************!*\
  !*** ./js/utils/form-data-storage.js ***!
  \***************************************/
/*! exports provided: startStoringData */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "startStoringData", function() { return startStoringData; });
var formMain = document.querySelector('[data-order-form]');
...
function storeFormData(formBlock) {
  if (formBlock) {
    var userName = formBlock.querySelector('[data-name-input] input');
    var userNameKey = 'user-name';
    var userTel = formBlock.querySelector('[data-telephone-input] input');
    var userTelKey = 'user-telephone';
    var userMail = formBlock.querySelector('[data-email-input] input');
    var userMailKey = 'user-email';
...
/*!***********************************!*\
  !*** ./js/utils/form-validate.js ***!
  \***********************************/
/*! exports provided: turnFormValidationOn */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "turnFormValidationOn", function() { return turnFormValidationOn; });
var formMain = document.querySelector('[data-order-form]');
var emailPattern = /^[^ ]+@[^ ]+\.[a-z]{2,4}$/;
var phonePattern = /^((\d|\+\d)[\- ]?)?(\(?\d{1,}\)?[\- ]?)?[\d\- ]*$/;
function validateEmail(formBlock) {
  var input = formBlock.querySelector('[data-email-input] input');
  if (input) {
    input.addEventListener('input', function () {
      var mailValue = input.value;
...
function validateTelephone(formBlock) {
  var input = formBlock.querySelector('[data-telephone-input] input');
  if (input) {
    input.addEventListener('input', function () {
      var telephoneValue = input.value;
...
function validateName(formBlock) {
  var input = formBlock.querySelector('[data-name-input] input');
  if (input) {
    input.addEventListener('input', function () {
...
/***/ "./js/utils/navigation-scroll.js":
/*!***************************************!*\
  !*** ./js/utils/navigation-scroll.js ***!
  \***************************************/
/*! exports provided: turnNavScrollOn, scrollToBlock */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "turnNavScrollOn", function() { return turnNavScrollOn; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "scrollToBlock", function() { return scrollToBlock; });
var navBar = document.querySelector('[data-navigation]');
...
function navigationScroll(navMenu) {
  if (navMenu) {
    var strengthsLink = navMenu.querySelector('[data-strengths-link]');
    var cruisesLink = navMenu.querySelector('[data-cruises-link]');
    var contactsLink = navMenu.querySelector('[data-contacts-link]');
    var strengthsBlock = document.querySelector('[data-strengths]');
    var cruisesBlock = document.querySelector('[data-cruises]');
    var contactsBlock = document.querySelector('[data-contacts]');
...
/***/ "./js/utils/trap-menu-focus.js":
/*!*************************************!*\
  !*** ./js/utils/trap-menu-focus.js ***!
  \*************************************/
/*! exports provided: trapMenuFocus */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "trapMenuFocus", function() { return trapMenuFocus; });
function trapMenuFocus(item) {
  var previousFocusItem = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : document.activeElement;
  var focusItems = Array.from(item.querySelectorAll('a[href]:not([disabled]), button:not([disabled]), textarea:not([disabled]), input[type="text"]:not([disabled]), input[type="radio"]:not([disabled]), input[type="checkbox"]:not([disabled]), select:not([disabled])'));
  if (focusItems && focusItems.length > 1) {
    var initialFocusItem = focusItems[0];
    var lastFocusItem = focusItems[focusItems.length - 1];
